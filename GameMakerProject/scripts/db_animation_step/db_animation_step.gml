...
function GetDbAllAnimationStepArray() {
	return [
		...
		// Player mine
		// Player right arm
		new AnimationStep(AnimationIndex.PlayerMineRightArm, 10, 6, undefined, undefined, 10, undefined),
		new AnimationStep(AnimationIndex.PlayerMineRightArm, 40, 6, undefined, undefined, 240, undefined),
		// Player left arm
		new AnimationStep(AnimationIndex.PlayerMineLeftArm, 10, 6, undefined, undefined, 10, undefined),
		new AnimationStep(AnimationIndex.PlayerMineLeftArm, 40, 6, undefined, undefined, 240, undefined),
		// Player right leg
		new AnimationStep(AnimationIndex.PlayerMineRightLeg, 10, 0, undefined, undefined, 0, undefined),
		new AnimationStep(AnimationIndex.PlayerMineRightLeg, 10, 0, undefined, undefined, 0, undefined),
		// Player left leg
		new AnimationStep(AnimationIndex.PlayerMineLeftLeg, 10, 0, undefined, undefined, 0, undefined),
		new AnimationStep(AnimationIndex.PlayerMineLeftLeg, 10, 0, undefined, undefined, 0, undefined)
	];
}